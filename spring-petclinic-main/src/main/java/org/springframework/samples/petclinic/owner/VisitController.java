...
class VisitController {
	...
	public Visit loadPetWithVisit(@PathVariable("petId") int petId, Map<String, Object> model) {
		...
		List<Vet> vets = (List<Vet>) this.vets.findAll();
		model.put("pet", pet);
		model.put("vets", vets);
		model.put("pets", pet.getOwner().getPets());
	...
	public String initUpdateForm(@PathVariable("petId") int petId, @PathVariable("visitId") int visitId, Map<String, Object> model) {
	...
	@GetMapping("/owners/{ownerId}/pets/{petId}/visits/{visitId}/active")
